...
//      var image = document.getElementById("cpet")
//      var image = document.getElementById("chome")
//      var image = document.getElementById("chealth")
//      var overlay = document.getElementById("comingsoon");
...
const gambarheader = document.querySelector('.gambarheader');
 ...
 // Event listener untuk mengatur efek parallax saat menggulir
window.addEventListener('scroll', () => {
     const scrollPos = window.scrollY;
     gambarheader.style.transform = `translateY(${scrollPos * 0.6}px)`; // Sesuaikan kecepatan parallax di sini
});
